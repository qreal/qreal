...
В режиме проверки сессия будет автоматически закрыта по факту завершения исполнения программы, в этом случае код возврата будет содержать бинарную информацию о корректности программы. Пример: 
    ...
    <message>
        <location filename="../../../../plugins/robots/interpreters/twoDModelRunner/main.cpp" line="41"/>
        <source>Run emulation in background.</source>
        <translation>Произвести эмуляцию в фоне.</translation>
    </message>
    <message>
        <location filename="../../../../plugins/robots/interpreters/twoDModelRunner/main.cpp" line="43"/>
    ...
    <message>
        <location filename="../../../../plugins/robots/interpreters/twoDModelRunner/main.cpp" line="44"/>
    ...
    <message>
        <location filename="../../../../plugins/robots/interpreters/twoDModelRunner/main.cpp" line="46"/>
