...
namespace qrRepo {
	...
	private:
		RepoApi(RepoApi const &other);  // Р С™Р С•Р С—Р С‘РЎР‚Р С•Р Р†Р В°РЎвЂљРЎРЉ Р Р…Р ВµР В»РЎРЉР В·РЎРЏ.
		RepoApi& operator =(RepoApi const &);  // Р СџРЎР‚Р С‘РЎРѓР Р†Р В°Р С‘Р Р†Р В°РЎвЂљРЎРЉ РЎвЂљР С•Р В¶Р Вµ.
