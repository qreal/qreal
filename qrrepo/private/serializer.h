...
public:
	...
	void saveToDisk(QList<Object *> const &objects, QHash<QString, QString> const &metaInfo) const;
	void loadFromDisk(QHash<qReal::Id, Object *> &objectsHash, QHash<QString, QString> &metaInfo);
...
private:
	...
	void saveMetaInfo(QHash<QString, QString> const &metaInfo) const;
	void loadMetaInfo(QHash<QString, QString> &metaInfo) const;
