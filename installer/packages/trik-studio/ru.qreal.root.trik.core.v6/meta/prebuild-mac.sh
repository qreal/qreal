...
fix_dependencies $BIN_DIR/plugins/tools/librobots-trik-v6-runtime-uploader-plugin.dylib   $QT_DIR/lib @executable_path/../../..
...
cp     $BIN_DIR/plugins/tools/librobots-trik-v6-runtime-uploader-plugin.dylib              $PWD/../data/plugins/tools/
