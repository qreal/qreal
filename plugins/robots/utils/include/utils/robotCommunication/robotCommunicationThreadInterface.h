...
public slots:
	virtual void send(QObject *addressee, const QByteArray &buffer, int responseSize) = 0;
	virtual void send(const QByteArray &buffer, int responseSize, QByteArray &outputBuffer) = 0;
