...
#include <trikCommon/robotCommunication/runProgramProtocol.h>
#include <trikCommon/robotCommunication/stopRobotProtocol.h>
#include <trikCommon/robotCommunication/uploadProgramProtocol.h>
...
using namespace trik::robotCommunication;
