...
private:
	...
	QScopedPointer<robotCommunication::TcpRobotCommunicator> mCommunicator;
	...
	QScopedPointer<robotCommunication::UploadProgramProtocol> mUploadProgramProtocol;

	/// Protocol that is used to upload and run program.
	QScopedPointer<robotCommunication::RunProgramProtocol> mRunProgramProtocol;

	/// Protocol that is used to stop robot.
	QScopedPointer<robotCommunication::StopRobotProtocol> mStopRobotProtocol;
};
