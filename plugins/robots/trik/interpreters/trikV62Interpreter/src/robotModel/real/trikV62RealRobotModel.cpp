...
#include <trikInterpreterCommon/robotModel/real/parts/display.h>
#include <trikInterpreterCommon/robotModel/real/parts/speaker.h>
#include <trikInterpreterCommon/robotModel/real/parts/button.h>

#include <trikInterpreterCommon/robotModel/real/parts/powerMotor.h>
#include <trikInterpreterCommon/robotModel/real/parts/servoMotor.h>
#include <trikInterpreterCommon/robotModel/real/parts/encoderSensor.h>

#include <trikInterpreterCommon/robotModel/real/parts/touchSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/lightSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/infraredSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/sonarSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/motionSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/gyroscope.h>
#include <trikInterpreterCommon/robotModel/real/parts/accelerometer.h>
#include <trikInterpreterCommon/robotModel/real/parts/colorSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/led.h>
#include <trikInterpreterCommon/robotModel/real/parts/lineSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/objectSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/shell.h>
#include <trikInterpreterCommon/robotModel/real/parts/gamepadButton.h>
#include <trikInterpreterCommon/robotModel/real/parts/gamepadConnectionIndicator.h>
#include <trikInterpreterCommon/robotModel/real/parts/gamepadPad.h>
#include <trikInterpreterCommon/robotModel/real/parts/gamepadPadPressSensor.h>
#include <trikInterpreterCommon/robotModel/real/parts/gamepadWheel.h>

#include <trikCommon/robotCommunication/networkCommunicationErrorReporter.h>
...
RealRobotModel::RealRobotModel(const QString &kitId, const QString &robotId)
	...
	, mRobotCommunicator(new robotCommunication::TcpRobotCommunicator("TrikTcpServer"))
{
	connect(mRobotCommunicator.data(), &robotCommunication::TcpRobotCommunicator::connected
			, this, &RealRobotModel::connected);
	connect(mRobotCommunicator.data(), &robotCommunication::TcpRobotCommunicator::disconnected
...
{
	robotCommunication::NetworkCommunicationErrorReporter::connectErrorReporter(
			*mRobotCommunicator
			, errorReporter
			);
}
