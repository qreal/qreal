...
WaitForColorBlockGenerator::WaitForColorBlockGenerator(LogicalModelAssistInterface const &model
		, GeneratorCustomizer &customizer
		, Id const &id
		, QObject *parent)
	: BindingGenerator(model, customizer, id, "waitColor.t", QList<Binding *>(), parent)
{
}
