...
Ev3ReservedFunctionsConverter::Ev3ReservedFunctionsConverter(const QStringList &pathsToTemplates)
	: TemplateParametrizedEntity(pathsToTemplates)
{
}

QString Ev3ReservedFunctionsConverter::convert(const QString &name, const QStringList &args) const
{
