...
/// Represent a main entity of 2D model constraings language. Event is an entity that just waits for condition and
/// then fires trigger. It may be setted up or dropped (i.e. has "alivness" state). In dropped state the trigger
...
public:
	...
	/// Returns the unique identifier of this event that can be used for mannual setting up or dropping this event.
	QString id() const;
