...
public:
	...
	void drawRect(int x, int y, int width, int height, bool filled, bool redraw) override;
	void drawRect(int x, int y, int width, int height, bool redraw) override;

	void drawCircle(int x, int y, int radius, bool filled, bool redraw) override;
