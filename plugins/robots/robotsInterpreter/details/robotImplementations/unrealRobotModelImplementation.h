...
#include "sensorImplementations/unrealDisplayImplementation.h"
...
public:
	...
	virtual sensorImplementations::UnrealDisplayImplementation &display();
...
private:
	...
	sensorImplementations::UnrealDisplayImplementation mDisplay;
