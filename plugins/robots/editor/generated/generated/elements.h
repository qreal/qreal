...
#include "../../../../../qrgui/editorPluginInterface/elementTitleHelpers.h"
	...
	public:
		...
		{
			Q_UNUSED(repo);
			title_2->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("WaitForCompletion")).replace("\n", "<br>"));
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Ports")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_3->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Power")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_5->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("TachoLimit")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
	...
	public:
		...
		{
			Q_UNUSED(repo);
			title_2->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Body")).replace("\n", "<br>"));
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Condition")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("port_1")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_3->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("port_2")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_5->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("port_3")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_7->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("port_4")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Iterations")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Port")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			Q_UNUSED(repo);
			Q_UNUSED(repo);
			title_3->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Frequency")).replace("\n", "<br>"));
			title_4->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Duration")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_6->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("WaitForCompletion")).replace("\n", "<br>"));
		}
	...
	public:
							...
							SdfRendererInterface *portRenderer)
		{
			...
			title_1 = factory.createTitle(-0.94, 1.2, "Задержка (мс): ##Delay##", true);
			title_1->setBackground(Qt::transparent);
			title_1->setScaling(false, false);
			title_1->setFlags(0);
			title_1->setTextInteractionFlags(Qt::NoTextInteraction);
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Задержка (мс): ") + repo->logicalProperty("Delay") + QString::fromUtf8("")).replace("\n", "<br>"));
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Port")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_3->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Color")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Port")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_3->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Intensity")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_5->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Sign")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Port")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_3->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("TachoLimit")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
	...
	public:
		...
		void updateData(ElementRepoInterface *repo) const
		{
			title_1->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Port")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_3->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Distance")).replace("\n", "<br>"));
			Q_UNUSED(repo);
			title_5->setHtml(QString("<b>%1</b>").arg(QString::fromUtf8("Sign")).replace("\n", "<br>"));
			Q_UNUSED(repo);
		}
