...
#include "D:/qrealGen/qrgui/toolPluginInterface/toolPluginInterface.h"
#include "generator.h"

namespace generators {
namespace qUbiqPresentationGenerator {

class QUbiqPresentationGeneratorPlugin : public QObject, public qReal::ToolPluginInterface
{
	Q_OBJECT
	Q_INTERFACES(qReal::ToolPluginInterface)
	Q_PLUGIN_METADATA(IID "generators.qUbiqPresentationGenerator.QUbiqPresentationGeneratorPlugin")

public:
	QUbiqPresentationGeneratorPlugin();
	virtual ~QUbiqPresentationGeneratorPlugin();
