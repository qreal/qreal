...
public:
	...
	qReal::CheckStatus checkAction_1(qReal::Id const &element, qrRepo::LogicalRepoApi const &logicalApi);

	QList<qReal::CheckStatus> checkAction(qReal::Id const &element, qrRepo::LogicalRepoApi const &logicalApi);
