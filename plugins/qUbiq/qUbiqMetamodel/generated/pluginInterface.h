...
class QUbiqMetamodelPlugin : public QObject, public qReal::EditorInterface
{
	Q_OBJECT
	Q_INTERFACES(qReal::EditorInterface)
	Q_PLUGIN_METADATA(IID "QUbiqMetamodel")

public:

	QUbiqMetamodelPlugin();

	QString id() const { return "QUbiqMetamodel"; }
