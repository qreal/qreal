...
class DragonAtomMetamodelPlugin : public QObject, public qReal::EditorInterface
{
	Q_OBJECT
...
public:
	...
	virtual QString id() const { return "DragonAtomMetamodel"; }
