...
public:
	...
	LabelInterface *createLabel(int index, qreal x, qreal y, const QString &text
			, qreal rotation, bool focused = false);
	LabelInterface *createLabel(int index, qreal x, qreal y, const QString &binding
			, bool readOnly, qreal rotation, bool focused = false);
