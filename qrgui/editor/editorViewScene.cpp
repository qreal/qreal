...
void EditorViewScene::createElement(QMimeData const *mimeData, const QPointF &scenePos , bool searchForParents
...
void EditorViewScene::highlight(const Id &graphicalId, bool exclusive, QColor const &color)
{
	if (exclusive) {
