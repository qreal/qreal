...
void EditorViewScene::insertNodeIntoEdge(qReal::Id &insertedNodeId, qReal::Id const &parentId, bool isFromLogicalModel,QPointF const &scenePos){
	foreach (QGraphicsItem *item, items(scenePos)) {
