...
class QextSerialRegistrationWidget : public QWidget
{
	...
	protected:
		...
		QEXTSERIALPORT_EXPORT bool winEvent( MSG* message, long* result );
};
#endif // QT_GUI_LIB
#endif // Q_OS_WIN
...
Q_OBJECT
	public:
		QEXTSERIALPORT_EXPORT QextSerialEnumerator( );
		QEXTSERIALPORT_EXPORT ~QextSerialEnumerator( );
	...
	public:
		...
		*/
		QEXTSERIALPORT_EXPORT static QList<QextPortInfo> getPorts();
		/*!
		  Enable event-driven notifications of board discovery/removal.
		*/
		QEXTSERIALPORT_EXPORT void setUpNotifications( );
