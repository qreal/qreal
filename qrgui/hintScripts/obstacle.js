...
var init = sceneAPI.initialNode();
var mainScene = guiFacade.widget("Scene");
hintAPI.addHint("Добавим пару блоков из палитры на сцену...", 2000, mainWindow);
var palette = guiFacade.widget("Palette");
var engF = paletteAPI.dragPaletteElement("qrm:/RobotsMetamodel/RobotsDiagram/NxtEnginesForward", 1500, 150, 275);
var sonar = paletteAPI.dragPaletteElement("qrm:/RobotsMetamodel/RobotsDiagram/NxtWaitForSonarDistance"  , 1500, 250, 275);
...
var engB = paletteAPI.dragPaletteElement("qrm:/RobotsMetamodel/RobotsDiagram/NxtEnginesBackward", 2000, 350, 275);
var beep = paletteAPI.dragPaletteElement("qrm:/RobotsMetamodel/RobotsDiagram/NxtBeep", 2000, 450, 275);
...
API.pickComboBoxItem(sensors, "Сенсор расстояния", 1000);
...
var wall = pluginGuiFacade.widget("PushButton", "wallButton");
cursor.moveTo(wall, 1000);
cursor.leftButtonPress(wall);
cursor.leftButtonRelease(wall);
var scene = pluginGuiFacade.d2ModelScene();
cursor.sceneMoveTo(scene, 2000, 400, 100);
