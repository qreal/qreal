...
Id GraphicalModelAssistApi::createElement(Id const &parent, Id const &id, DragFrom dragFrom, QString const &name, QPointF const &position)
{
	return mModelsAssistApi.createElement(parent, id, dragFrom, name, position);
}
