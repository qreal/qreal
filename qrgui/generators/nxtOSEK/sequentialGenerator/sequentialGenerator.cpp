...
SequentialGenerator::SequentialGenerator(qrRepo::RepoControlInterface &api, QString const &destinationPath)
	: NxtOSEKgenerator(api, destinationPath)
{
}

SequentialGenerator::SequentialGenerator(QString const &pathToRepo, QString const &destinationPath)
...
gui::ErrorReporter &SequentialGenerator::generate()
{
	...
	foreach (Id curInitialNode, initialNodes) {
		...
		/* Generate C file */
		QFile templateCFile(":/generators/nxtOSEK/sequentialGenerator/templates/template.c");
		...
		/* Generate OIL file */
		QFile templateOILFile(":/generators/nxtOSEK/sequentialGenerator/templates/template.oil");
		...
		/* Generate makefile */
		QFile templateMakeFile(":/generators/nxtOSEK/sequentialGenerator/templates/template.makefile");
