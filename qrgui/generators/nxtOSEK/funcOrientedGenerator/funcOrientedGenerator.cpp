...
FuncOrientedGenerator::FuncOrientedGenerator(qrRepo::RepoControlInterface &api, QString const &destinationPath)
	: NxtOSEKgenerator(api, destinationPath) {
}

FuncOrientedGenerator::FuncOrientedGenerator(QString const &pathToRepo, QString const &destinationPath)
