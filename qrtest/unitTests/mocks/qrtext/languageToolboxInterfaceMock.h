...
public:
	...
	MOCK_CONST_METHOD3(parse, QSharedPointer<qrtext::core::ast::Node> &(const qReal::Id &id
			, const QString &propertyName
			, const QString &code));
	MOCK_METHOD2(ast, QSharedPointer<qrtext::core::ast::Node>(const qReal::Id &id, const QString &propertyName));
	MOCK_METHOD1(type, QSharedPointer<qrtext::core::types::TypeExpression>(
	...
	MOCK_METHOD0(variableTypes, QMap<QString, QSharedPointer<qrtext::core::types::TypeExpression>>());
	MOCK_CONST_METHOD0(specialIdentifiers, QStringList&());
	MOCK_CONST_METHOD0(specialConstants, QStringList&());
	MOCK_METHOD0(clear, void());
	MOCK_METHOD2(isGeneralization, bool(const QSharedPointer<qrtext::core::types::TypeExpression> &specific
