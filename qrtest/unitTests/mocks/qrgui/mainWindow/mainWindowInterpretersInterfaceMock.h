...
public:
	...
	MOCK_METHOD2(unloadConstraintsPlugin, bool(QString const &pluginName, QString const &pluginId));
	MOCK_METHOD1(loadConstraintsPlugin, bool(QString const &fileName));
